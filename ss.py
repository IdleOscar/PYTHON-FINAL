...
def Move_file():
    global titleText, title1Text, title1location, f1
    f1 = Frame(root, width=350, height=300, background="lavender")
    f1.grid(row=5, column=0, columnspan=4)

    titlelocation = StringVar()
    title1location = StringVar()

    TITLE = Label(f1, text="Select The File To Move", font="bold", bg='lavender')
    TITLE.grid(row=0, column=0, pady=5, padx=5)

    titleText = Entry(f1, width=50, textvariable=titlelocation, font="12")
    titleText.grid(row=0, column=1, pady=5, padx=5)
    title_browse = Button(f1, text="Browse",bg='lightblue', command=titlebrowse, width=15, font="bold")
    title_browse.grid(row=0, column=2, pady=5, padx=5)

    TITLE1 = Label(f1, text="Select The Folder", bg="lavender", font="bold")
    TITLE1.grid(row=1, column=0, pady=5, padx=5)

    title1Text = Entry(f1, width=50, textvariable=title1location, font=12)
    title1Text.grid(row=1, column=1, pady=5, padx=5)
    title1_browse = Button(f1, text="Browse", bg='lightblue', command=title1browse, width=15, font="12")
    title1_browse.grid(row=1, column=2, pady=5, padx=5)
...
def titlebrowse():
    ...
    titleText.insert("1", files_list)


def title1browse():
    directory = filedialog.askdirectory()
    title1Text.insert("1", directory)
...
def move_file():
    dest_location = title1location.get()
    for f in files_list:
...
lbl_heading = Label(root, text="File Manager App",font=("bold",18),fg="black",bg='silver')
...
copy_move_btn = Button(root, text="Move File", command=Move_file, width=15,font=('bold',14))
